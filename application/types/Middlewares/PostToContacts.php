...
use \ReddeRationem\BilancioCivico\Commands\Mail;
use \Twig_Environment as Environment;
class PostToContacts{
	private $environment = null;
	private $mail = null;
	public function __construct(Environment $environment, Mail $mail){
