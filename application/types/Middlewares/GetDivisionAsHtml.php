...
use \ReddeRationem\BilancioCivico\Queries\SelectDivision;
use \Twig_Environment as Environment;
class GetDivisionAsHtml{
	private $environment = null;
	private $selectDivision = null;
	public function __construct(Environment $environment, SelectDivision $selectDivision){
	...
	public function __invoke(Request $request, Response $response, callable $next) : Response{
		...
		$arguments['division'] = $this->selectDivision->submit($arguments);
		$response->getBody()->write($this->environment->render('division.html', $arguments));
		return $response;
	}
}