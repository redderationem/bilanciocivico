...
use \ReddeRationem\BilancioCivico\Queries\SelectAtAGlance;
...
class GetHomeAsHtml{
	...
	public function __invoke(Request $request, Response $response, callable $next) : Response{
		...
		$arguments = array_replace(
			$arguments,
			[
				'atAGlance' =>  $this->selectAtAGlance->submit($arguments),
				'divisionsAtAGlance' => $this->selectDivisionsAtAGlance->submit($arguments)
			]
		);
		$response->getBody()->write($this->environment->render('home.html', $arguments));
		return $response;
	}
}