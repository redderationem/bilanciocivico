...
use \ReddeRationem\BilancioCivico\Queries\SelectSubject;
use \Twig_Environment as Environment;
class GetSubjectAsHtml{
	private $environment = null;
	private $selectSubject = null;
	public function __construct(Environment $environment, SelectSubject $selectSubject){
	...
	public function __invoke(Request $request, Response $response, callable $next) : Response{
		...
		$arguments['subject'] = $this->selectSubject->submit($arguments);
		$response->getBody()->write($this->environment->render('subject.html', $arguments));
		return $response;
	}
}