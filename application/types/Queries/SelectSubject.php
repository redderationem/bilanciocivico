...
class SelectSubject{
	...
	public function submit(array $arguments = []){
		...
		LEFT JOIN "denormalizedTransactions" ON "denormalizedTransactions"."subjectId" = "denormalizedSubjects"."id"
		WHERE "denormalizedSubjects"."code" = ?
		GROUP BY "denormalizedSubjects"."id"
		LIMIT 1
		OFFSET 0
SQL;
